...
if(!isset($_SESSION[$vist_page]) || $_SESSION[$vist_page]!=1)
{
	...
	$site_refer = $_SERVER['HTTP_REFERER'];
	 ...
	 $myfile = file_put_contents('iplist.txt',date("Y-m-d - H:i:s - "). $country. " ". $ip." | ". $vist_page." | ". $user_os. " | ". $user_browser. " | From: ". $site. " | user agent:" .$user_agent .PHP_EOL , FILE_APPEND | LOCK_EX);
	fclose($myfile);
}
?>